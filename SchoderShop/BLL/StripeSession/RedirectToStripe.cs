...
namespace SchoderShop.BLL.StripeSession
{
    public class RedirectToStripe : Processor
    {
        ...
        public RedirectToStripe(StripeData stripeData, ISlackManager slackManager) : base(slackManager) => _stripeData = stripeData;

#pragma warning disable 1998
        protected override async Task<bool> ProcessOkAsync()
        {
#pragma warning restore CS1998
            _stripeData.HttpResponse.Headers.Add(Constants.HEADER_STRIPE_REDIRECT, _stripeData.StripeCheckoutSession.Url);
